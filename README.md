...
Raw files from STL miniatures are not optimized for digital platforms. To improve performance it's necessary to decrease the overall size and the vertex count of the original model. This is achieved by using a combination techniques like remesh, decimation and 'normals baking', before painting the miniature models.
